...
<div class="container">
    <div class="row">
        <div class="col-lg-4 col-md-6 my-3">
            ...
            <img src="./uploads/inside-table.jpg" class="card-img-top">
                <div class="card-body">
                <h5>Sitting Area: Inside</h5>
                <div class="d-flex justify-content-evenly mb-1">
                <a href="#" class="btn btn-outline-primary shadow-none">Book Now</a>
                </div>
                </div>
            </div>
        </div>

...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <?php
            //check the id is in url because we get the product by its id
            if (isset($_GET['id'])) {
                $id = $_GET['id'];
                            ...
                            <form action="code.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea row="3" required name="small_description" placeholder="Enter Small Description" class="form-control mb-2"><?= $data['small_description']; ?></textarea>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" required name="qty" placeholder="Enter Quantity" class="form-control mb-2" value="<?= $data['qty']; ?>">
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea row="3" required name="meta_description" placeholder="Enter Meta Description" class="form-control"><?= $data['meta_description']; ?></textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="mb-0">Meta Keywords</label>
                                        <textarea row="3" required name="meta_keywords" placeholder="Enter Meta Keywords" class="form-control"><?= $data['meta_keywords']; ?></textarea>
                                    </div>
            ...
            <?php
                    ...
                    echo "Product not found gor the given id";
                }
            } else {
